...
# Template HTML para exibir o QR Code
HTML_TEMPLATE = '''
<!DOCTYPE html>
<html>
<head>
...
<body>
    <div class="container">
        ...
        <p><small>Esta pagina atualiza automaticamente a cada 5 segundos</small></p>
    </div>
</body>
</html>
'''
    ...
    try:
        ...
        if status_response.status_code == 200:
            ...
            if status_data.get('status') == 'WORKING':
                return render_template_string(HTML_TEMPLATE, status='connected')
        ...
        if qr_response.status_code == 200:
            ...
            if 'image' in content_type:
                ...
                if 'value' in data:
                    return render_template_string(HTML_TEMPLATE, qr_code=data['value'])

            return render_template_string(HTML_TEMPLATE, status='error',
...
def create_session():
    """Cria a sessão do WhatsApp se não existir"""
    try:
        headers = {
            "Content-Type": "application/json",
            "X-Api-Key": WAHA_API_KEY
        ...
        print(f"Sessao criada: {response.status_code}")
...
if __name__ == '__main__':
    ...
    print("Criando sessao do WhatsApp...")

    # Criar a sessão em uma thread separada
